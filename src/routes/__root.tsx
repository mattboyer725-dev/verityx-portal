...
const APP_NAME = "VerityX Sovereign — Live Desk";
  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Live Siemens Gamesa procurement — SAP/Ariba, LME cash, Argus REE, EcoVadis, Circulor DPP, 27-node PBFT, Okta Workforce.",
      },
